...
<head>
	...
	<body>
		<div>
			<div class="navbar navbar-expand-md navbar-dark fixed-top bg-info">
				<a class="navbar-brand">Sistem Informsi Uang Kas</a>
				<a float="left" class="btn btn-outline-light" href="<?= base_url('index.php/Home') ?>">Home</a>
			</div>>
		</div>
		<div class="container text-center">
			<div class="login-panel panel panel-default">
				...
				<div class="panel-body">
					<form role="form" method="post" action="<?php echo base_url(); ?>index.php/siswa/Login_siswa/aksi_login" class="form-signin text-center">
						<?php
						if(!empty($notif)){
