...
<body>
	...
	<div class="container">
		...
		<div class="login-panel panel panel-default">
			<form action="<?php echo base_url(). 'index.php/bendahara/data_bendahara/update'; ?>" method="post">
				<table class="table">
					<tr>
						<td>ID Bendahara</td>
						<td>
							<input class="form-control" type="text" name="id_bendahara" value="<?php echo $u->id_bendahara ?>">
						</td>
					</tr>
					<tr>
						<td>NIS</td>
