		...
		<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center" style="padding-top: 800px;">
			<table class="table table-bordered table-striped table-hover" >
				...
				<tr>
					...
					<td>
					    <?php echo anchor('walikelas/data_walikelas/edit/'.$u->id_walikelas,'Edit'); ?>
		                <?php echo anchor('walikelas/data_walikelas/hapus/'.$u->id_walikelas,'Hapus'); ?>
					</td>
				</tr>
				<?php } ?>
			</table>
			<center><?php echo anchor('walikelas/data_walikelas/tambah','Tambah Data'); ?></center>
		</div>
	</div>
</body>
</html>