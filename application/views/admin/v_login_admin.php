		...
		<div class="container text-center">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">
					<h1 class="h3 mb-3 font-weight-normal">Login Khusus Admin</h1>
				</div>
				<div class="panel-body">
					<form role="form" method="post" action="<?php echo base_url(); ?>index.php/admin/Login_admin/aksi_login" class="form-signin text-center">
						<?php
						if(!empty($notif)){
